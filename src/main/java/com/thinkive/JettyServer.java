...
public class JettyServer
{
    ...
    public JettyServer() throws ClassNotFoundException
    {
        ...
        // Class.forName("com.thinkive.market.web.MarketServlet"),
        // "/cgi-bin/market/market");
        // context.addServlet((Class<? extends Servlet>)
        // Class.forName("com.thinkive.market.web.JsonServlet"),
        // "/market/json");
        // context.addServlet((Class<? extends Servlet>)
        // Class.forName("com.thinkive.market.web.TestServlet"),
        // "/market/test");
        // context.addServlet((Class<? extends Servlet>)
        // Class.forName("com.thinkive.market.web.StateServlet"),
        // "/market/state");
